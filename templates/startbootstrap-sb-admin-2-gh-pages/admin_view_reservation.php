...
<?php
   ...
   $sql = "SELECT reserve.reserve_id, reserve.book_id, reserve.l_id, reserve.reservation_date, reserve.reservation_status,
            l.l_id, l.username, l.status, book.book_id, book.book_title from reserve_book reserve, login l, book_table book where reserve.l_id = l.l_id and reserve.book_id = book.book_id and  reserve.reservation_status = '0'";
...
?>
                                    ...
                                    <?php
                                             ...
                                             <?php echo "<td><a href='PHP/reserve_approve.php?x=" .$row['reserve_id']. " ' class = 'btn btn-success btn-sm'><i class='fa fa-check' aria-hidden='true'></i></a></a>"; 
