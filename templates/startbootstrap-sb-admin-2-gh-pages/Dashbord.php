                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sql = "SELECT member_id from member_registration";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sql1 = "SELECT book_id from book_table";
                       ...
                       <!---<div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Book Categories 
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
